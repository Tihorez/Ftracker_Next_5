...
func (t Training) TrainingInfo() InfoMessage {
	return InfoMessage{t.TrainingType, t.Duration,
		t.distance(), t.meanSpeed(), t.Calories()}
}
...
func (w Walking) Calories() float64 {
	return ((CaloriesWeightMultiplier*w.Weight + (math.Pow(w.meanSpeed()*KmHInMsec, 2)/
		w.Height)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
}
